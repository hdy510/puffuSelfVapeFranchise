      ...
      <div className={styles.container} ref={ref}>
        <div className={styles.wrap}>
          ...
          <ul className={styles.meritsBox}>
            <li className={`${styles.meritsEach} ${styles.index0}`}>
            ...
            <li className={`${styles.meritsEach} ${styles.index1}`}>
            ...
            <li className={`${styles.meritsEach} ${styles.index2}`}>
            ...
            <li className={`${styles.meritsEach} ${styles.index3}`}>
            ...
            <li className={`${styles.meritsEach} ${styles.index4}`}>
